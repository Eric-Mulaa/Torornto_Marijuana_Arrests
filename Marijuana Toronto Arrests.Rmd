...
arrests %>%
  ...
  arrange(desc(n))
```
We can see that most male and female got arrested in 2000 with 1165 arrests for male and 105 for female. 2002 had the least arrests for both categories
...
```
From the above piechart we can see that from the total arrests for black people 74.1% were released while 25.9% were not released
...
```
From the above piechart we can see that out of the total arrest for white people 85.8% were released while 14.2% were not released.
